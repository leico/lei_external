...
#include "lei.SerialToSimpleControl.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
	...
	GIVEN("An instance of our object") {
		...
		test_wrapper<lei_SerialToSimpleControl> an_instance;
		lei_SerialToSimpleControl&              my_object = an_instance;
